    ...
    return OnBoardingSlider(
      ...
      background: [
        Padding(
          ...
          child: Lottie.asset('assets/lottiefiles/foodd3.json',height: 400),
        ),
        Padding(
          padding: const EdgeInsets.only(top: 50,left: 35),
          child: Lottie.asset('assets/lottiefiles/foodd6.json',height: 300),
        ), Padding(
          padding: const EdgeInsets.only(top: 50,left: 100),
          child: Lottie.asset('assets/lottiefiles/foodd4.json',height: 300),
        ),
